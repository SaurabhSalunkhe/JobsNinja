...
<table class="table table-condensed">
	  		<tbody>
		  		<tr>
		  			<td><label for="jobTitle" class="control-label">Job Title: ${job.getJobTitle()}</label></td>
		  		</tr>
		  		<tr>
		  			<td><label for="description" class="control-label">Description:${job.getDescription()}</label></td>
		  		</tr>
		  		<tr>
		  			<td><label for="job position" class="control-label">Positions:${job.getPositions()}</label></td>
		  			<tr>
		  			</tr>
		  		</tr>
		  			<tr>
			  			<td><a href="applyToJob?id=${job.getId()}" class="btn btn-lg btn-info">Apply</a></td>
			  		</tr>
