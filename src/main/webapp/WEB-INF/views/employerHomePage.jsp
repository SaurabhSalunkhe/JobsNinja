...
<body style="background-color: ivory">
	...
	<div class="applicantHomePage">
		<a href="employerprofile" class="list-group-item">My Profile</a> <a
			href="employerpostjob" class="list-group-item">Post a Job</a> <a
			href="employerviewjobs" class="list-group-item">View Jobs</a> <a
