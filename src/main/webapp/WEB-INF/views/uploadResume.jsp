...
<form:form commandName="applicant" method="POST" action="uploadResumeSubmit.htm" enctype="multipart/form-data">						
			
			<div style="width:800px; font-size:2em; height:400px;margin:0px auto">
					<p>Upload your resume (Acceptable Formats: pdf)</p>					
					<p></>Select Resume<input type="file" name="photo" /></p>			
						<p>
					<button type="submit"
