...
<nav class="navbar navbar-default navbar-inverse" style="margin-bottom: 0px;border-radius: 0px;">
	...
	<form:form commandName="job" action="employerpostJobSubmit" method="POST">
	<div class="row">
		
			<label for="jobTitle" >Job Title</label>
			<form:input path="jobTitle" cssClass="form-control" required="required" pattern="[a-z]{1,15}"/>
		
		
			<label for="description" >Description</label>
			<form:input path="description" required="required" pattern="[a-z]{1,15}" cssClass="form-control" />
		
			
			<label for="positions" >Positions</label>
			<form:input path="positions" type="number" cssClass="form-control" required="required"/>
			<br>
