				...
				<tbody>
					...
					<c:forEach var="application" items="${applications}">
						<tr>
							...
							<c:if test="${not empty application.user.filename}">
								<td class="text-center"><a class="btn btn-primary btn-md"
									href="viewApplicantResume?applicantId=${application.user.id}">Resume
								</a></td>
							</c:if>
							<c:if test="${empty application.user.filename}">
								<td class="text-center"><span>No Resume submitted</span></a></td>
							</c:if>
							<td class="text-center"><a class="btn btn-primary btn-md"
								href="sendEmail?applicantId=${application.user.id}">Email</a></td>
						</tr>
					</c:forEach>
				</tbody>
			</table>
